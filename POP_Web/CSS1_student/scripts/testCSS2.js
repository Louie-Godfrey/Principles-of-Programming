...
QUnit.test("Element with ID of secStatic has the correct styles", function(assert){
    ...
    assert.strictEqual(testResult, true, "Element with ID secStatic has the correct color (" + colorProperty + ") and position (" + secPosition + ") and border color (" + borderColor + ") and  width (" + secWidth + ") and background color (" + bgColour + ")");
...
QUnit.test("Element with ID of secRelative has the correct styles", function(assert){
    ...
    assert.strictEqual(testResult, true, "Element with ID secRelative has the correct color (" + colorProperty + ") and position (" + secPosition + ") and left value correct (" + secLeft + ") and border color (" + borderColor + ") and  width (" + secWidth + ") and background color (" + bgColour + ")");
