...
class MyArraysUnitTests5 {
	...
	void testUnitGrades() {
		...
		String[] gradesAnswer = { "APP:64", "BSAD:55", "CF:45", "DAD:67", "N&CS:65", "POP:88", "Average:64.0" };
		assertArrayEquals(gradesAnswer, myArrays.unitMarks(grades));
		int[] grades2 = { 50, 50, 50, 50, 50, 53 };
		String[] gradesAnswer2 = { "APP:50", "BSAD:50", "CF:50", "DAD:50", "N&CS:50", "POP:53", "Average:50.5" };
